...
var _bulmaAccordionMin = __webpack_require__(3);

var _bulmaAccordionMin2 = _interopRequireDefault(_bulmaAccordionMin);
...
function titulares_beneficiarios_info(inputs) {
	...
	if (inputs["beneficiario1_name"] != "") {
		...
		if (inputs["titular2_name"] != "") inputs["beneficiario1_info2"] = "a) " + inputs["beneficiario1_stock"] + " acciones por parte del señor " + inputs[inputs["beneficiario1_stock_from"] + "_name"] + " a favor de " + inputs["beneficiario1_name"];
	}
	if (inputs["beneficiario2_name"] != "") {
		...
		if (inputs["titular2_name"] != "") inputs["beneficiario2_info2"] = "b) " + inputs["beneficiario2_stock"] + " acciones por parte del señor " + inputs[inputs["beneficiario2_stock_from"] + "_name"] + " a favor de " + inputs["beneficiario2_name"];
	}
	if (inputs["beneficiario3_name"] != "") {
		...
		if (inputs["titular2_name"] != "") inputs["beneficiario3_info2"] = "c) " + inputs["beneficiario3_stock"] + " acciones por parte del señor " + inputs[inputs["beneficiario3_stock_from"] + "_name"] + " a favor de " + inputs["beneficiario3_name"];
	}
	if (inputs["beneficiario4_name"] != "") {
		...
		if (inputs["titular2_name"] != "") inputs["beneficiario4_info2"] = "d) " + inputs["beneficiario4_stock"] + " acciones por parte del señor " + inputs[inputs["beneficiario4_stock_from"] + "_name"] + " a favor de " + inputs["beneficiario4_name"];
	}
...
function sellers_buyers_info(inputs) {
	...
	if (inputs["seller1_name"] != "") {
		sellers_info += inputs["seller1_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["seller1_city"] + ", quien actúa en nombre propio, identificado con la cédula de ciudadanía No " + inputs["seller1_id"] + ". ";
	...
	if (inputs["seller2_name"] != "") {
		sellers_info += inputs["seller2_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["seller2_city"] + ", quien actúa en nombre propio, identificado con la cédula de ciudadanía No " + inputs["seller2_id"] + ". ";
	...
	if (inputs["seller3_name"] != "") {
		sellers_info += inputs["seller3_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["seller3_city"] + ", quien actúa en nombre propio, identificado con la cédula de ciudadanía No " + inputs["seller3_id"] + ". ";
	...
	if (inputs["seller4_name"] != "") {
		sellers_info += inputs["seller4_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["seller4_city"] + ", quien actúa en nombre propio, identificado con la cédula de ciudadanía No " + inputs["seller4_id"] + ". ";
	...
	if (inputs["seller5_name"] != "") {
		sellers_info += inputs["seller5_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["seller5_city"] + ", quien actúa en nombre propio, identificado con la cédula de ciudadanía No " + inputs["seller5_id"] + ". ";
	...
	if (inputs["buyer1_name"] != "") {
		buyers_info += inputs["buyer1_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["buyer1_city"] + ", quien actúa en nombre propio, identificado con la cédula de ciudadanía No " + inputs["buyer1_id"] + ". ";
		...
		inputs["buyer1_tobuy_info5"] = "a) El señor " + inputs[inputs["buyer1_stock_from"] + "_name"] + " la cantidad de " + inputs["buyer1_stock_tobuy"] + " acciones que representan el " + helper + "% del total del capital suscrito de la sociedad " + inputs["company_name"] + " a favor del señor " + inputs["buyer1_name"];
	...
	if (inputs["buyer2_name"] != "") {
		buyers_info += inputs["seller2_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["buyer2_city"] + ", quien actúa en nombre propio, identificado con la cédula de ciudadanía No " + inputs["buyer2_id"] + ". ";
		...
		inputs["buyer2_tobuy_info5"] = "b) El señor " + inputs[inputs["buyer2_stock_from"] + "_name"] + " la cantidad de " + inputs["buyer2_stock_tobuy"] + " acciones que representan el " + helper + "% del total del capital suscrito de la sociedad " + inputs["company_name"] + " a favor del señor " + inputs["buyer2_name"];
	...
	if (inputs["buyer3_name"] != "") {
		buyers_info += inputs["buyer3_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["buyer3_city"] + ", quien actúa en nombre propio, identificado con la cédula de ciudadanía No " + inputs["buyer3_id"] + ". ";
		...
		inputs["buyer3_tobuy_info5"] = "c) El señor " + inputs[inputs["buyer3_stock_from"] + "_name"] + " la cantidad de " + inputs["buyer3_stock_tobuy"] + " acciones que representan el " + helper + "% del total del capital suscrito de la sociedad " + inputs["company_name"] + " a favor del señor " + inputs["buyer3_name"];
	...
	if (inputs["buyer4_name"] != "") {
		buyers_info += inputs["buyer4_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["buyer4_city"] + ", quien actúa en nombre propio, identificado con la cédula de ciudadanía No " + inputs["buyer4_id"] + ". ";
		...
		inputs["buyer4_tobuy_info5"] = "d) El señor " + inputs[inputs["buyer4_stock_from"] + "_name"] + " la cantidad de " + inputs["buyer4_stock_tobuy"] + " acciones que representan el " + helper + "% del total del capital suscrito de la sociedad " + inputs["company_name"] + " a favor del señor " + inputs["buyer4_name"];
	...
	if (inputs["buyer5_name"] != "") {
		buyers_info += inputs["buyer5_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["buyer5_city"] + ", quien actúa en nombre propio, identificado con la cédula de ciudadanía No " + inputs["buyer5_id"] + ". ";
		...
		inputs["buyer5_tobuy_info5"] = "c) El señor " + inputs[inputs["buyer5_stock_from"] + "_name"] + " la cantidad de " + inputs["buyer5_stock_tobuy"] + " acciones que representan el " + helper + "% del total del capital suscrito de la sociedad " + inputs["company_name"] + " a favor del señor " + inputs["buyer5_name"];
...
$(document).ready(function () {
	...
	$("form.process:not([id])").submit(function (e) {
		...
		$.each($(this).serializeArray(), function () {
			if (this.name != "template") inputs["" + this.name] = this.value;
		});
	...
	$("form.process#acciones").submit(function (e) {
		...
		inputs["seller_stock_total"] = parseInt(inputs["seller1_stock"], 10) + parseInt(inputs["seller2_stock"], 10) + parseInt(inputs["seller3_stock"], 10) + parseInt(inputs["seller4_stock"], 10) + parseInt(inputs["seller5_stock"], 10);

		inputs["seller_stock_tosale_total"] = parseInt(inputs["seller1_stock_tosale"], 10) + parseInt(inputs["seller2_stock_tosale"], 10) + parseInt(inputs["seller3_stock_tosale"], 10) + parseInt(inputs["seller4_stock_tosale"], 10) + parseInt(inputs["seller5_stock_tosale"], 10);

		inputs["seller_stock_total_price"] = parseInt(inputs["seller1_stock_total_price"], 10) + parseInt(inputs["seller2_stock_total_price"], 10) + parseInt(inputs["seller3_stock_total_price"], 10) + parseInt(inputs["seller4_stock_total_price"], 10) + parseInt(inputs["seller5_stock_total_price"], 10);
	...
	$("form.process#cesion").submit(function (e) {
		...
		var inquorum = [];
		if ($('input[name=accionista1_inquorum]:checked').length > 0) inquorum.push([inputs["accionista1_name"], inputs["accionista1_stock"], inputs["accionista1_%"]]);
		if ($('input[name=accionista2_inquorum]:checked').length > 0) inquorum.push([inputs["accionista2_name"], inputs["accionista2_stock"], inputs["accionista2_%"]]);
		if ($('input[name=accionista3_inquorum]:checked').length > 0) inquorum.push([inputs["accionista3_name"], inputs["accionista3_stock"], inputs["accionista3_%"]]);
		if ($('input[name=accionista4_inquorum]:checked').length > 0) inquorum.push([inputs["accionista4_name"], inputs["accionista4_stock"], inputs["accionista4_%"]]);
		if ($('input[name=accionista5_inquorum]:checked').length > 0) inquorum.push([inputs["accionista5_name"], inputs["accionista5_stock"], inputs["accionista5_%"]]);
		...
		inputs["acciones_suscritas"] = parseInt(inputs["accionista1_stock"], 10) + parseInt(inputs["accionista2_stock"], 10) + parseInt(inputs["accionista3_stock"], 10) + parseInt(inputs["accionista4_stock"], 10) + parseInt(inputs["accionista5_stock"], 10);
	...
	$("form.process#estatutos").submit(function (e) {
		...
		if (inputs["accionista1_name"] != "") {
			accionistas_info += inputs["accionista1_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["accionista1_city"] + ", " + inputs["accionista1_country"] + ",  identificado con cédula de ciudadanía No " + inputs["accionista1_id"];
		}
		if (inputs["accionista2_name"] != "") {
			accionistas_info += ", " + inputs["accionista2_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["accionista2_city"] + ", " + inputs["accionista2_country"] + ",  identificado con cédula de ciudadanía No " + inputs["accionista2_id"];
		}
		if (inputs["accionista3_name"] != "") {
			accionistas_info += ", " + inputs["accionista3_name"] + ", mayor de edad, domiciliado (a) en la ciudad de " + inputs["accionista3_city"] + ", " + inputs["accionista3_country"] + ",  identificado con cédula de ciudadanía No " + inputs["accionista3_id"];
		}
